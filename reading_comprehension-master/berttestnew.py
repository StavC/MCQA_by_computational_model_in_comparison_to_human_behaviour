...
def load_data(args, is_training=True):
    if args.run_yev:
        ...
        return read_race_examples(Path(__file__).parent/'data'/'RACE'/'train'/'middle', is_training=is_training)
...
def main():
    ...
    if args.local_rank != -1:
        ...
        print('n_gpu>1 YESSSSSSSSSSSSSSSSSSSSSSSSSSS')
    ...
    if args.fp16:
        print('YESSSSSSSSSSSSSSSSSSSSS args.fp16')
        try:
    ...
    global_step = 0
    if args.do_train:
        print('YESSSSSSSSSSS args.do_train')
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration",miniters=1)):
                n_trained_batches += 1
                ...
                if (step + 1) % args.gradient_accumulation_steps == 0:
                    if args.fp16:
                        ...
                        lr_this_step = args.learning_rate * get_linear_schedule_with_warmup(optimizer,warmup_steps=global_step,t_total=num_train_optimization_steps,
                                                                          )
